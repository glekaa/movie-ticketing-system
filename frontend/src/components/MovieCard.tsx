...
const MovieCard = ({ movie, onClick }: MovieCardProps) => {
    return (
        <div className="flex flex-col gap-3 group cursor-pointer w-[45vw] sm:w-[200px] md:w-[250px] lg:w-[350px] shrink-0 border-1 border-[#40403f] rounded-2xl shadow-[0px_5px_10px_2px_#292827]" onClick={onClick}>
