...
const Hero = () => {
    ...
    const genreTags = currentMovie.genres.map((g) => ({ type: "primary" as const, text: g }));
    const durationTag = { type: "primary" as const, text: formatDuration(currentMovie.duration_minutes) };
    const allTags = [...genreTags, durationTag];
