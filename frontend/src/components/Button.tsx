...
const Button = ({ children, variant = "primary", icon, className = "", ...props }: ButtonProps) => {
  ...
  const baseStyles = "flex items-center justify-center gap-2 rounded-full px-6 py-2 font-semibold text-sm font-['Montserrat'] transition-all duration-300 ease-out hover:scale-105 active:scale-95 tracking-wide";
  const primaryStyles = "bg-gradient-to-b from-[#00A3FF] to-[#0055FF] shadow-[0_8px_20px_-4px_rgba(0,102,255,0.5)] hover:shadow-[0_12px_25px_-4px_rgba(0,102,255,0.7)] ring-1 ring-inset ring-white/30 text-white hover:brightness-110";
