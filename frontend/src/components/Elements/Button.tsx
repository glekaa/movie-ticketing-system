...
const Button = ({ children, variant = "primary", icon, className = "", ...props }: ButtonProps) => {
  ...
  const baseStyles = "flex items-center justify-center gap-2 rounded-full px-6 py-2 font-semibold text-sm font-['Montserrat'] transition-all duration-300 ease-out hover:scale-105 active:scale-95 tracking-wide cursor-pointer whitespace-nowrap";
